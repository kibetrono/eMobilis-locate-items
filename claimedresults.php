...
if($id ==1){
        ...
        echo"        <div class='card display'> ";
              ...
              echo    "
              <a href='#showDetails' >
              <img style='width:100%;max-height:180px' src='assets/claim/".$row['image']."' alt=''>
              </a>
              ";
                  echo"  <hr> ";
                  echo"   <h4>";
                  ...
                  <div class='row'>
    <div class='col-md-5'>
    <a class='btn btn-success text-center' href='showclaimed.php?show=$id'>Show Details</a>
    </div>
    <div class='col-md-3'></div>
    <div class='col-md-4'>
    <a class='btn btn-danger' href='deleteclaim.php?del=$id'>Delete</a>
