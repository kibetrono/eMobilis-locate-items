...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-0">
   ...
   <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block h4" style="text-decoration:none">David Rono</a>
    ...
    <section class="content">
      <form action="verifypost.php" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="row my-4">
          ...
          <div class="col-md-6">
            <input type="submit" name="postitem" class="form-control bg-secondary" style="width:50%;font-size:25px;height:50px" value="Post Found Item">
          </div>
          <div class="col-md-3"></div>
