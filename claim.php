...
?>
  ...
  <div class="content-wrapper whole">
    ...
    <section class="content">
     ...
     <form action="verifyclaim.php" method="POST" autocomplete="off" enctype="multipart/form-data">
...
<div class="row my-4">
  ...
  <div class="col-md-6">
    <input type="submit" name="claimitem" class="form-control bg-secondary" style="width:100%" value="Claim Item">
  </div>
  <div class="col-md-3"></div>
